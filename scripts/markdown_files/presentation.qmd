...
## Spatial Model {.smaller}
Mean of Rho converges around $0.34$ suggesting weak to moderate spatial correlation. ![](../../figures/spatial_rho.png){width=85%}
...
- Benefits seen for spatio-temporal, but more work needs to be done to see if we are over-fitting our data
